package com.example.bulut.mychat.Yemek;
...
public class Yemek extends AppCompatActivity
    ...
    private ImageView yemek_image;
    private String url ="https://bogazicipansiyon.files.wordpress.com/2015/05/wpid-screenshot_2015-05-05-12-02-02-1.png";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        yemek_image =  findViewById(R.id.imageView);
        Picasso.get().load(url).into(yemek_image);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent intent = new Intent(Yemek.this, Anasayfa.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            final AlertDialog.Builder builder= new AlertDialog.Builder(Yemek.this);
