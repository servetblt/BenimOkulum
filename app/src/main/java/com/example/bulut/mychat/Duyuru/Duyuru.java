...
public class Duyuru extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {


    private android.support.v7.widget.Toolbar toolbar;
    private RecyclerView rv;
    private ArrayList<Duyurular> duyuruListele;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Duyuru.this, DuyuruIcerik.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            Intent intent = new Intent(Duyuru.this, Anasayfa.class);
            startActivity(intent);
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            final AlertDialog.Builder builder= new AlertDialog.Builder(Duyuru.this);
    ...
    public void tumduyurular(){

        String url="http://maarifokullarigine.com/servet/duyuruGetir.php";
        StringRequest stringRequest=new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    JSONArray kisilerliste=jsonObject.getJSONArray("tbl_duyuru");

                    for(int i=0; i<kisilerliste.length(); i++){
                        JSONObject d=kisilerliste.getJSONObject(i);

                        String baslik=d.getString("baslik");
                        String icerik=d.getString("icerik");

                        Duyurular kisi=new Duyurular(baslik,icerik);
                    ...
                    adapter=new DuyuruAdapter(Duyuru.this,duyuruListele);
